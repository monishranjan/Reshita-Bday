...
function App() {
  return (
    <div style={{
      ...
      <section style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '0 1rem' }}>
        <Greeting />
        ...
        <motion.img 
          ...
          style={{ width: '200px', height: '200px', objectFit: 'cover', borderRadius: '50%', border: '4px solid var(--primary)', marginTop: '2rem', boxShadow: '0 0 20px rgba(255,123,156,0.3)' }}
          alt="Us"
        />
        ...
        <motion.div
          ...
          style={{ position: 'absolute', bottom: '40px', color: 'var(--primary)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}
        >
